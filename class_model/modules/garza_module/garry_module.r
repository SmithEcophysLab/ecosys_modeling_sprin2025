...
## By Garry Garza (and 99% risa lol)


# The purpose of this module will be to incorporate the Johnson & Berry Cytb6f model into a module for use in our class model
